...
export class ReportsComponent implements OnInit {
  ...
  getArticleFromToData() {
    this.reportsService
      .articleProfitBetweenDates(this.date2, this.date3)
      .subscribe(
        (data) => {
  ...
  getArticleDayData() {
    ...
    let day = this.date1.getUTCDate() + 1;
    this.reportsService.articleProfitDay(year, month, day).subscribe(
      (data) => {
        this.articleReportData = data;
        this.fixUpData();
      },
  ...
  getArticleMonthData() {
    this.reportsService
      .articleProfitMonth(
        this.articleMonthYearInput,
        this.articleMonthInput.value
      )
      .subscribe(
        (data) => {
          this.articleReportData = data;
  ...
  getArticleQuarterData() {
    this.reportsService
      .articleProfitQuarter(
        this.articleQuarterYearInput,
        this.articleQuarterInput.value
      )
      .subscribe(
        (data) => {
          this.articleReportData = data;
  ...
  getArticleYearlyData() {
    this.reportsService
      .articleProfitYearReport(this.articleYearInput)
      .subscribe(
        (data) => {
          this.articleReportData = data;
          this.fixUpData();
  ...
  getNames() {
    let names: string[] = [];
    Object.entries(this.articleReportData.articleProfits).forEach(
      ([key, value]) => {
